...
| Configurações gerais | P0 | `src/app/settings/` | Auditoria encontrou props literais em componentes de Settings; painel de memória recebeu primeiro lote | Em implementação — validação visual pendente | Busca, seções, labels, tooltips, empty/error/loading states |
