      ...
      >
        {expanded ? (
          ...
          <>
            ...
            <Button aria-label={t.ui.moreEmoji} onClick={() => setExpanded(true)} size="icon-sm" variant="ghost">
              <Plus />
            </Button>
          </>
        )}
    ...
    >
      {reactions.map(reaction =>
        reaction.author === 'user' && onRetract ? (
          <button
            aria-label={t.ui.removeReaction(reaction.emoji)}
