...
export const en: Translations = {
  ...
  settings: {
    ...
    customEndpoints: {
      ...
      use: 'Use',
      delete: 'Delete',
      deleteTitle: name => `Delete endpoint ${name}?`,
  ...
  ui: {
    ...
    memoryProviderSettingsFailed: message => `Memory provider settings failed to load: ${message}`,
    retry: 'Retry',
    dangerZone: 'Danger zone',
    checkingInstalled: "Checking what's installed…",
    confirmUninstall: 'Confirm uninstall',
    thisRemoves: consequence => `This removes ${consequence}. This can't be undone.`,
    yesUninstall: 'Yes, uninstall',
    uninstalling: 'Uninstalling…',
    uninstallHermes: 'Uninstall Hermes',
    uninstallDescription:
      'Choose how much to remove. The app closes to finish the job; reopen the installer any time to come back.',
    configSettings: label => `${label} settings`,
