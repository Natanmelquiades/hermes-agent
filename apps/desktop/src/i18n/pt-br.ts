...
export const ptBrOverrides: TranslationOverrides = {
  common: {
    apply: 'Aplicar',
    back: 'Voltar',
    save: 'Salvar',
  ...
  settings: {
    ...
    customEndpoints: {
      loading: 'Carregando endpoints personalizados…',
      ...
      use: 'Usar',
      delete: 'Excluir',
      deleteTitle: name => `Excluir o endpoint ${name}?`,
      ...
      context: 'Contexto',
      apiKey: 'Chave de API',
      keepCurrentKey: 'Deixe em branco para manter a chave atual',
      optional: 'Opcional',
      ...
      reachableWithModels: count => `Endpoint acessível. ${count} modelos encontrados.`,
      reachable: 'Endpoint acessível.',
      validationFailed: 'Falha na validação do endpoint.',
      saveFailed: 'Falha ao salvar',
...
function mergeOverrideTrees(base: Record<string, unknown>, extra: Record<string, unknown>): Record<string, unknown> {
  const result: Record<string, unknown> = { ...base }

  for (const [key, value] of Object.entries(extra)) {
    const previous = result[key]
    result[key] = isRecord(previous) && isRecord(value) ? mergeOverrideTrees(previous, value) : value
  }

  return result
}

const ptBrSupplement: TranslationOverrides = {
  fileMenu: {
    download: 'Baixar',
...
export const ptBrOverridesComplete = mergeOverrideTrees(
  ptBrOverrides as Record<string, unknown>,
  ptBrSupplement as Record<string, unknown>
) as TranslationOverrides
export const ptBr = defineLocale(ptBrOverridesComplete)
